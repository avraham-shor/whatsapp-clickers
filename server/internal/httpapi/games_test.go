...
func gamesRouter(games GameStore) http.Handler {
	...
	return NewRouter(stubPinger{}, svc, games, testStatic(), nil, nil, nil, nil, nil, nil)
}
...
func TestGameMutationsWithoutSessionReturn401(t *testing.T) {
	router := NewRouter(stubPinger{}, noAuth(), draftGame(), testStatic(), nil, nil, nil, nil, nil, nil)
