...
- **Human step still open (release-blocking)**: Railway `SESSION_SECRET` is the 1.1 placeholder — set a real value in Railway Variables **before merging to main** (README runbook step 4 updated with the warning).
